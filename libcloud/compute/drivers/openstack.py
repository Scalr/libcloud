...
class OpenStackNodeDriver(NodeDriver, OpenStackDriverMixin):
    ...
    def iterate_nodes(self, ex_all_tenants=False, ex_page_size=PAGINATION_LIMIT):
        """
    ...
    def iterate_volumes(self, ex_page_size=PAGINATION_LIMIT):
        """
        :param ex_page_size: Request page size.
        :type ex_page_size: ``int``
        """
...
class OpenStack_1_1_NodeDriver(OpenStackNodeDriver):
    ...
    def ex_iterate_snapshots(self, ex_page_size=PAGINATION_LIMIT):
        """
        :param ex_page_size: Request page size.
        :type ex_page_size: ``int``
        """
